package pbo2.pkg10119073.latihan29.warnakepribadian;
...
public class PBO210119073Latihan29WarnaKepribadian {
...
public static void hasiltes(String warnafav){
        String warna = warnafav.toUpperCase(); 
        
        switch (warna) {
            case "MERAH":
                System.out.print("Warna Favoritmu adalah"+ANSI_RED+" MERAH \n"+ANSI_RESET);
                ...
                break;
            case "HIJAU":
                System.out.print("Warna Favoritmu adalah"+ANSI_GREEN+" HIJAU \n"+ANSI_RESET);
                ...
                break;
            case "KUNING":
                System.out.print("Warna Favoritmu adalah"+ANSI_YELLOW+" KUNING \n"+ANSI_RESET);
                ...
                break;
            case "BIRU":
                System.out.print("Warna Favoritmu adalah"+ANSI_BLUE+" BIRU \n"+ANSI_RESET);
                ...
                break;
            case "UNGU":
                System.out.print("Warna Favoritmu adalah"+ANSI_PURPLE+" UNGU \n"+ANSI_RESET);
                System.out.println("1. Optimis,\n"
                        + "2. TIdak pernah ragu,\n"
